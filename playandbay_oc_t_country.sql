...
LOCK TABLES `oc_t_country` WRITE;
/*!40000 ALTER TABLE `oc_t_country` DISABLE KEYS */;
INSERT INTO `oc_t_country` VALUES ('CA','Canada','canada'),('GB','United Kingdom','united-kingdom'),('RU','Russia','russia'),('US','United States','united-states');
