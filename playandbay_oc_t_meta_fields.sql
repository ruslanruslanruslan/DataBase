...
LOCK TABLES `oc_t_meta_fields` WRITE;
/*!40000 ALTER TABLE `oc_t_meta_fields` DISABLE KEYS */;
INSERT INTO `oc_t_meta_fields` VALUES (1,'Тип','new-custom-field','DROPDOWN','продам,куплю',1,1),(2,'Предлагаю / ищу','new-custom-field_1','DROPDOWN','предлагаю,ищу',1,1),(3,'Пересыл','new-custom-field_2','DROPDOWN','за счет продавца,за счет покупателя,невозможен',1,1),(4,'Обмен','new-custom-field_3','DROPDOWN','возможно,невозможно',1,1);
